...
%calculate the shape function and first derivatives计算形函数和一阶导数
%INPUT: e - element index
%       u_hat - evaluation point in u-direction reference coordinates (from -1 to 1)u方向参考坐标的索引点
%       v_h - evaluation point in v-direction reference coordinates (from -1 to 1)
%       Ce - local Bezier extraction operator
%       p,q - polynomial degrees
%OUTPUT: N - value of the p+1 shape functions at the evaluation pointp+1形状函数在求值点的值
%        dN - derivatives of the p+1 shape functions in physicalp+1形状函数在物理中的导数
